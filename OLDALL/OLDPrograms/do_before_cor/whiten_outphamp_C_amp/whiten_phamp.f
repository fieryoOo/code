...
c ==========================================================
     ...
     1  rec_am,seis_outamp,seis_outph,ns,dom)
      implicit none
      include 'fftw3.h'
      integer*4 npow,n
      real*8    f1,f2,f3,f4,dt
      real*4    seis_in(7500000),seis_out(7500000)
      real*4    seis_outamp(1000000), seis_outph(1000000), rec_am(1000000)
c ---
      integer*4 k,ns,nk,i
      real*8    plan1,plan2
      real*8    dom
...
c     do smoothing on sf equivalent to do " smooth mean h 20" in SAC
      ...
      call smooth(f1,f2,f3,f4,dom,nk,sf,rec_am)
C=============================================================
c===============================================================
c   make tapering
...
c==================================================================
c  smoothing routine      call smooth(f1,f2,f3,f4,dom,nk,sf,rec_am)
c=s================================================================
      subroutine smooth(f1,f2,f3,f4,dom,nk,sf,rec_am)
      real*8    f1,f2,f3,f4
      integer*4 nk
      double complex sf(7500000)
      real*8    sorig(7500000), dom
      real*8    rec_am(1000000),f,sum, avg
c ---
        do i = 1,nk
