//revised to retain amplitude information.
//no time-domain normalization applied. earthquake signal picked and set to zero
//spectrum are whiten by a fixed function
//output am, ph and rec (to keep track of correlation time length) files
