...
//  char event_name[300];
  ...
  for(;;)
      ...
      for(;;)
	{
      ...
      fclose(fgradx);
      fclose(fgrady);
      sprintf(buff1,"/home/tianye/code/Script/GMT/C_plot_travel %s_am_gradx.txt_v2 /home/tianye/data_Eikonal/SAC_XR/region_XR",event_name);
      system(buff1);
      sprintf(buff1,"/home/tianye/code/Script/GMT/C_plot_travel %s_am_grady.txt_v2 /home/tianye/data_Eikonal/SAC_XR/region_XR",event_name);
      system(buff1);
