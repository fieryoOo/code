...
c      call smooth(f1,f2,f3,f4,dom,nk,sf,20)
C=============================================================
c===============================================================
c   make tapering
c      call flt4(f1,f2,f3,f4,dom,nk,npow,sf)
...
c      enddo
c      do k= 1,500
c         temp=(1-dcos((k-1.0)/500.0*dpi))/2.0d0 
c         seis_out(k)=seis_out(k)*temp
c         seis_out(n+1-k)=seis_out(n+1-k)*temp
c      enddo
c      do k = n+1,ns
c         s(k) = czero
c      enddo
...
c      enddo
c       make backward FFT for seismogram: s ==> sf
c      call dfftw_plan_dft_1d(plan1,ns,s,sf,
c     *                         FFTW_BACKWARD, FFTW_ESTIMATE)
c      call dfftw_execute(plan1)
c      call dfftw_destroy_plan(plan1)
c      do k = nk+1,ns
c         sf(k) = czero
c      enddo
