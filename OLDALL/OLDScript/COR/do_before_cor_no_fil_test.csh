...
#                /home/tianye/code/Programs/do_before_cor/filter4/filter4 param.dat 0
#
#                awk '{print "80 60 5 4 1 1  ", $1, $1"_10.0_30.0"}' temp.ft > param.dat
#                /home/tianye/code/Programs/do_before_cor/whiten_outphamp_C_cut_onebit/whiten_rej_phamp_no_fil  param.dat
#                \rm ft_*.SAC ft_*.SAC_10.0_30.0
#                \rm temp.ft param.dat
#                cd ../
#                set nfile=`ls $dirday | wc -l`
...
#                awk '{print "80 60 5 4 1 1  ", $1}' temp.ft > param.dat
#                /home/tianye/code/Programs/do_before_cor/whiten_outphamp_C_onebit/whiten_rej_phamp_no_fil  param.dat
awk '{print "200 150 5 4 1 1  ", $1}' temp.ft > param.dat
/home/weisen/progs/NOISE_CODA/FTA/filter4_f/filter4  param.dat
/home/weisen/progs/NOISE_CODA/FTA/white_outphamp/white_outphamp_1bit_CV/whiten_rej_phamp  param.dat
                \rm ft_*.SAC ft_*.SAC_10.0_30.0
                \rm temp.ft param.dat
                cd ../
                set nfile=`ls $dirday | wc -l`
        ...
        cd ..
        rm -rf $bp'_onebit_whiten'
        mv $bp $bp'_onebit_whiten'
