...
if ( ! -e $label'_'$year'.'$month'.'$day1 ) continue
if ( $day1 == 1 ) then
...
echo ../$label'_'$year'.'$month'.'$day1 >> $year'.'$month'/input_ev_seed'
...
/home/tianye/code/Programs/do_before_cor/de_resp/sac_from_seed_holes_PZ_64 LHZ
/home/tianye/code/Programs/do_before_cor/de_resp/cut_trans_PZ_64 1000 84000
...
rm -rf from_seed input_ev_seed list_sac1 rdseed.err_log sac_bp_respcor sac_db.out
cd ..
end
exit
rm -rf $bp
