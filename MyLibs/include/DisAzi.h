...
protected:
	...
	static constexpr double Rb = 6356.7523142;
...
begin:
		...
		U1 = atan((oneminusf)*tan(lati1*pio180));
		U2 = atan((oneminusf)*tan(lati2*pio180));
	...
	void calc_azimuth() {
		...
		T U1 = atan((oneminusf)*tan(lati1*pio180));
		T U2 = atan((oneminusf)*tan(lati2*pio180));
