...
rm -f $argv[1]'/'$argv[1]'_center_normd_amp_neg_'$per'sec.txt'
...
echo $location $amp >> $argv[1]'/'$argv[1]'_center_normd_amp_neg_'$per'sec.txt'
end # file
...
/home/tianye/code/Script/GMT/C_plot_travel_positive $argv[1]'_center_normd_amp_neg_'$per'sec.txt' ~/region_TA
awk -v long=$long -v lati=$lati '$1>long-8 && $1<long+8 && $2>lati-10 && $2<lati+10' $argv[1]'_center_normd_amp_neg_'$per'sec.txt.HD' > temp_cpt
/home/tianye/code/Script/GMT/TXT2CPT temp_cpt
mv temp_cpt.cpt $argv[1]'_center_normd_amp_neg_'$per'sec.txt.HD.cpt'
rm -f temp_cpt
/home/tianye/code/Script/GMT/C_plot_kernel_input_sta $argv[1]'_center_normd_amp_neg_'$per'sec.txt.HD.cpt' $argv[1]'_center_normd_amp_neg_'$per'sec.txt.HD' ~/region_TA $argv[1]'.loc'
#end
