...
set m_pa='/home/tianye/code/Mineos/Mineos-Linux64-1_0_2/DEMO/models'
set m_na=$m_pa'/'$model'.txt'
# check model name
set flg=0
...
green
EOF
cp -p TA.site green.site
cp -p TA.sitechan green.sitechan
# create origin relation for data base green
creat_origin temp_cmt_event green
#============================================================
...
cp -p TA.site Syndat.site
cp -p TA.sitechan Syndat.sitechan
creat_origin temp_cmt_event Syndat
exit
