...
mkdir -p alpha_sm_result_-0.0035_0.0055_dynamic_1.7
mv 'alpha_'*'_map' alpha_sm_result_-0.0035_0.0055_dynamic_1.7
mv site_coef_map alpha_sm_result_-0.0035_0.0055_dynamic_1.7
cd alpha_sm_result_-0.0035_0.0055_dynamic_1.7
foreach file (alpha_crd_map alpha_raw_map alpha_prp_crd_map alpha_sit_crd_map)
awk '$4>30' $file > $file'_1'
~/code/Programs/mini_tools/Gauss_Smoothing_map $file'_1' 120
C_plot_travel $file'_1_smd' ~/region_TA 0.1
C_plot_input_region_res_csta '../alpha_'$per'.cpt' $file'_1_smd.HD' ~/region_TA 0.1 0_0
end
set file='alpha_crd_map_1'
C_plot_travel $file ~/region_TA 0.1
C_plot_input_region_res_csta '../alpha_'$per'.cpt' $file'.HD' ~/region_TA 0.1 0_0
foreach file (alpha_site_map alpha_prp_map)
awk '$4>30' $file > $file'_1'
C_plot_travel $file'_1' ~/region_TA 0.1
C_plot_input_region_res_csta '../alpha_ptb_'$per'.cpt' $file'_1.HD' ~/region_TA 0.1 0_0
end
cd ../..
end
