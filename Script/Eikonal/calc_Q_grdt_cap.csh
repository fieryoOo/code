#!/bin/csh
if ( $#argv != 6)then
echo "USAGE: get_event [SAC_path] [event.info] [station.lst] [per] [fix or dyn] [param_file]"
exit
endif
...
set sm_hdis=`awk '{print $1}' $para_f`
set p_coef=`awk '{print $3}' $para_f`
set s_coef=`awk '{print $4}' $para_f`
