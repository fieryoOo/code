#!/bin/csh
if ($#argv != 2)then
echo "usage: Statistic_avg [sac_path] [sta_loc_infile]"
exit
endif

cd $argv[1]
#set table_file='/home/tianye/data_Eikonal/SAC_XR/ph_diff_avg_table_XR'
...
set gray_red_cpt=`ls /home/tianye/data_Eikonal/SAC_XR/$period'sec_10snr_'$dis'dis/amp_diff_'$period's/gray_red_'*'steps.cpt'`
