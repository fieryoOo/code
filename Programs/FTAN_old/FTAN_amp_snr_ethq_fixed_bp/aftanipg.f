...
c        write(*,*) "Third trigger:"
        ...
        if(ierr1.ne.0) then
          ...
          do i = ist,ibe
            ...
            om1(i-ist+1)    = om(i)
          enddo
c          write(*,*) "Fourth trigger:"
          call trigger(grvel1,om1,nfout2,tresh,trig1, ftrig1,ierr1)
          do i = 1,nfout2
             write(*,*) "aaa: ",2*3.14159/om1(i), ftrig1(i)
          enddo
        ...
        do i = 1,nf
           write(*,*) "aaa: ",2*3.14159/om(i), ftrig(i)
        enddo
        ierr = 0
        nfout2 = nf
        do i = 1,nf
