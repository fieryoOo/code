...
c======================================================================
      implicit none
      include 'fftw3.h'
      integer*4 n,npoints,nf,nfin,nfout1,ierr,nrow,ncol,ntmp
      real*8    piover4,perc,taperl,tamp,arr1(8,100),arr2(7,100)
      real*8    t0,dt,delta,vmin,vmax,tmin,tmax,tresh,ffact,ftrig(100),tfact
      real*8    fsnr,fmatch
      real*4    sei(327680)
      double complex dczero,s(327680),sf(327680),fils(327680),tmp(327680)
      real*8    grvel(100),tvis(100),ampgr(100),om(100),per(100),tim(100)
      real*8    pha(327680,32),amp(327680,32),ampo(327680,32)
      real*8    time(327680),v(327680),b(327680)
      ...
      integer*4 ind(2,327680)
      real*8    ipar(6,327680)
...
c ---
      ...
      real*8    pred(300,2),omdom(327680), ampdom(327680)
      double complex dci,dc2,pha_cor(327680),env(327680),spref(327680)
