c g77 remveWaterNoiseAuto.f -o remveWaterNoiseAuto -lm /usr/local/sac/lib/libsacio.a
...
c  frequency ranges so set predicted noise to zero in low coherence bands.
      ...
      real*4 lfreq(1000),ufreq(1000)
      real*4 m0amp(1000),m1amp(1000),m2amp(1000),m0ph(1000)
        real*4 m1ph(1000),m2ph(1000)
