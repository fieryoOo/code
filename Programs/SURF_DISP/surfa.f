...
czzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
        ...
        common/newly/t1,dt,cc1,dc,lstop,iqq,istru
        dimension x(20),y(20)
c--------------------------------------------------------------------
        accur1=0.1e-5
        accur2=0.1e-7
...
c----------------------------------------------------------------------
         parameter (nsize=1000,nper=1000)
        common/d/  a(nsize),b(nsize),rho(nsize),d(nsize),qs(nsize)
        common/o/ cc(nper,10),tt(nper),rat(nper,10)
        common/c/ nmax,jmax,kmax,idrop,iedit,ndiv,mode,any
        ...
        common/deriv/ nderiv,ndpth,dpth(nsize),dspz(nsize),dsp(nsize),
     *  drvz(5,nsize),drv(5,nsize)
...
czzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
     ...
     5  dcdr(nsize),dcda(nsize),dcdb(nsize),dwx(nsize)
        ...
        common/d/   a(nsize),b(nsize),rho(nsize),d(nsize),qs(nsize)
        common/o/   cc(nper,10),tt(nper),rat(nper,10)
        common/c/   nmax,jmax,kmax,idrop,iedit,ndiv,mode,fact 
        common/newly/ te1,dete,ce1,dece,lstop,iqq,istru
        ...
        common/rco1/ sumi0,sumi1,sumi2,sumi3,flagr
        common/deriv/ nderiv,ndpth,dpth(nsize),dspz(nsize),dspr(nsize),
     *  drvz(5,nsize),drvr(5,nsize)
        logical KEY_ATTEN,KEY_FLAT,KEY_DERIV
	common/log/ KEY_ATTEN,KEY_FLAT,KEY_DERIV
        ...
        dimension dmrsmz(5),dmzsmr(5),depth(nsize),ampur(nsize),ampuz(nsize)
        dimension dmr(5),dmz(5),smr(5),smz(5),g1(nsize),g2(nsize)
        dimension pr(5*nsize),xlamb(nsize),xmu(nsize)
        data wwt/0.0,0.5,0.5,1.0/,wt/0.1666667,0.3333333,0.3333333,0.1666667/
c----------------------------------------------------------------------
                  do 99999 i=1,nsize
                  do 99999 j=1,5
        yy1(i,j)=1.
...
c-------------------------------------------------------------------
        ...
        common/d/ a(nsize),b(nsize),rho(nsize),d(nsize),qs(nsize)
        common/c/ nmax,q1,q2,q3,q4,q5,q6,q7
