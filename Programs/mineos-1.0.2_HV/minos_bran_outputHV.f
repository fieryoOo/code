...
c      print *,filnam(1:lnblnk(filnam))
...
c     write out the T, H/V ratio (-1*eigenV/eigenU)
      write(ioeig,*) tcom,-1*abuf(5+3*n)/abuf(5+n)
  300 format(i3,7f9.5)
      return
      end
