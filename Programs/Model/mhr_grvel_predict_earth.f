...
C----------------------------------------------------------------------------------------
	     ...
	     narg=iargc()
	     if(narg.ne.marg) STOP'USAGE: mhr_grvel_predict 
     1                    pathfile_name  map_name  perlist'
...
C-----loop for period-----------------------------------------------------E
      	    ...
      	    do j=1,npath
       	      write(2,*) ista(j),iev(j),nper, ' ',stnam(j),' ',evnam(j), 
     1                  stalat(j), stalon(j), evlat(j), evlon(j)
       	      write(12,*) ista(j),iev(j),nper, ' ',stnam(j),' ',evnam(j), 
     1                 stalat(j), stalon(j), evlat(j), evlon(j)
...
C#####################################################################
     ...
     1       stalon,stnam,iev,evlat,evlon,evnam,npath)
            ...
            real*4 stalat(100000),stalon(100000),
     1                evlat(100000),evlon(100000)
...
4           do j=1,1000000
     ...
     1                evnam(j),stalat(j),stalon(j),evlat(j),evlon(j)
		print *, ista(j),iev(j),' ',stnam(j),evnam(j),
     1               stalat(j),stalon(j),evlat(j),evlon(j)
            enddo
999         close(7)
	    npath=j-1
