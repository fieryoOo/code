...
//           calc_dist(slati, slong, latilst[k], longlst[k], &dist[k]);
           calc_azimuth(slati, slong, latilst[k], longlst[k], &alpha);
           l=(int)(alpha*10+0.5);
...
*/
          // if(amp1[l2]<0) cout<<amp1[l2]<<endl;
           if(amp1[k]==-1) continue;
           amp_tmp[l2]=amp1[k]*amp1[k];
           l2++;
//           amp1[l2]=-1.0;
//        cout.precision(10);
