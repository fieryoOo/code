C############################################################
       subroutine INTPOL(x,y,ninp,u0,du,nout,v,dv,ierr)
c----------------------------------------------------------------------
...
c-  dv(u) - output function derivatives values
...
c----------------- interpolation starts-------------------------------
      ...
      call SPLDER (1,ninp,x,y,am1,q,v(i),dv(i),dum1,*994)       
      q=q+du
150   continue
      return
c---------------------------------------------------------------
