...
flg=0
for f in \
CPacific NRussia prem_noocean prem_noocean_na prem_ocean WesternUS
do
if test "$f" = $1; then
flg=1
fi
...
echo "CPacific NRussia prem_noocean prem_noocean_na prem_ocean WesternUS"
exit
fi
#=========================================================
...
#fcmt=china_cmt_event
fcmt=20080221235751_cmt.info
echo "Step 5: green functions evaluation ........................."
if test -f green.wfdisc; then
 rm -rf green.*
fi
time ${bindir}/green << EOF
short
db_list
$fcmt
10 260
