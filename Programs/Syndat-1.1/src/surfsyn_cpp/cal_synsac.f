     ...
     +                       npoints, fr, df, nf, dt, nt, key_compr, elatc, elonc, qR, qL,
...
c----------Source term calculations-----------------S
            ...
            if(its.ne.'F')then
C      write(*,*) "debug1: j=",j," nt=",nt," vu = ",vu," du = ",du," br = ",br," bl = ",bl
            ...
            sumr=(0.0,0.0)
            do m=1,im
C      write(*,*) "debug2: tm=",tm(m)," br=",br(m)," step=",step
