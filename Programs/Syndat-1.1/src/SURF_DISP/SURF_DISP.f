...
c-------------------------------------------------------------------------
        integer*4 ilay,i,j,kind,ncount,ndiv_store,imax(10)
        integer*4 number,numbel,idispr,idispl,mmax_store,nlay_deriv
...
c       to be effective halfspace.
        ...
        dx=0.0d0
        nlay_deriv=0
        call INIT(dx,nlay_deriv,idispr,idispl,kind)
           ndiv_store=ndiv
           t1_store=t1
           mmax_store=mmax
c----------------------------------------------------------------------
