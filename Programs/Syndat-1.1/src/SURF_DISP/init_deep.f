         subroutine init(dx,nlay_deriv,idispr,idispl,kind)
C---------to initialize the program--------------------------
        implicit none
        integer*4 nsize,nper,nlay_deriv,idispr,idispl,kind
        real*8    dx
c ---
...
C       data ndpth/1000/,dpth0/0.0/,ddepth/0.5/,r0/6371.0/
...
C-------interpreting arguments--------------------------------S
        ...
        write(*,*) 'USAGE: SURF_DISP infile  outfile R/L kmin kmax tmin tmax tstep'
